...
export const experiments: ExperimentDefinition[] = [
  ...
  defineExperiment({
    ...
    description: {
      zh: 'Raw WebGPU + WGSL 的二维解算/三维体积混合实验：较小的细节化核心持续三维蠕动；点击或音频节拍将同一团材质沿稀疏径向主干撕开，再由延迟涡量卷曲并通过弹性位移解算融合回核心。爆裂半径具有硬上限，体积采样范围随核心动态收紧以提高细丝、薄片和内部烟雾层次的清晰度。',
      en: 'A Raw WebGPU + WGSL 2D-solver/3D-volume hybrid: a compact detailed core continuously crawls in 3D; pointer or audio impacts tear the same material along sparse radial trunks, then delayed vorticity curls the stretched sheets and filaments before elastic displacement fuses them back into the core. Burst radius is hard-limited and the raymarch bound tightens dynamically for sharper internal smoke, sheets, and filaments.',
    },
    category: { zh: '体积', en: 'Volume' },
    tags: ['WebGPU', 'WGSL', 'Volume', '2D Fluid', 'Fractal', 'Elastic Burst', 'Audio Reactive', 'Raymarch'],
