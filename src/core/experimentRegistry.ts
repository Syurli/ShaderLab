...
export const experiments: ExperimentDefinition[] = [
  ...
  defineExperiment({
    ...
    description: {
      zh: 'Raw WebGPU + WGSL 的二维解算/三维体积混合实验：平静核心持续三维蠕动；点击或音频节拍触发明确的展开—最大形变—弹性回收周期。二维流场只负责扭曲三维主干，不再直接填充体积；细丝、次级分叉和 metaball-like 微团沿主干生成并随主结构一起散开、回弹和融合。',
      en: 'A Raw WebGPU + WGSL 2D-solver/3D-volume hybrid: the idle core continuously crawls in 3D, while pointer or audio bursts run through explicit expansion, peak deformation, and elastic return phases. The 2D field only deforms the 3D trunks instead of filling the volume; filaments, secondary splits, and metaball-like micro volumes are linked to the trunks so they spread, rebound, and fuse with the main structure.',
    },
    category: { zh: '体积', en: 'Volume' },
    tags: ['WebGPU', 'WGSL', 'Volume', '2D Fluid', 'Fractal', 'Metaball', 'Elastic Burst', 'Audio Reactive', 'Raymarch'],
